...
exports.Divider = (0, react_1.forwardRef)(function Divider(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(Component, __assign({}, props, { ref: ref, role: role, className: (0, classnames_1.default)(block({ inset: !vertical && inset, vertical: vertical }), className) })));
});
