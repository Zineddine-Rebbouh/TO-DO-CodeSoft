...
export declare type Maybe<T, NotFound = null> = T | NotFound;
/**
 * A helper type that allows an optional `ref` to also be applied with a props
 * object even though a `ref` isn't a real prop.
 */
export declare type PropsWithRef<P extends {}, E extends HTMLElement> = P & {
    /**
 ...
 */
export declare type ClassNameCloneableChild<T = {}> = ReactElement<T & {
    className?: string;
}>;
/**
 ...
 */
export declare type LabelRequiredForA11y<Props extends LabelA11y> = RequireAtLeastOne<Props, keyof LabelA11y>;
/**
 * @remarks \@since 5.0.0
 * @internal
 */
