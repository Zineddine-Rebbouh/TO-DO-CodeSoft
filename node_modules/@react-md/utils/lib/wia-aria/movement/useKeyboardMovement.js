...
function useKeyboardMovement(_a) {
    ...
    var keys = (0, react_1.useMemo)(function () { return __spreadArray(__spreadArray(__spreadArray(__spreadArray([], __read((0, utils_2.transformKeys)(incrementKeys, "increment")), false), __read((0, utils_2.transformKeys)(decrementKeys, "decrement")), false), __read((0, utils_2.transformKeys)(jumpToFirstKeys, "first")), false), __read((0, utils_2.transformKeys)(jumpToLastKeys, "last")), false); }, [incrementKeys, decrementKeys, jumpToFirstKeys, jumpToLastKeys]);
