 ...
 */
export declare type FocusType = "increment" | "decrement" | "first" | "last";
/**
 ...
 */
export declare enum IncrementMovementKey {
    ArrowUp = "ArrowUp",
    ArrowDown = "ArrowDown",
    ArrowLeft = "ArrowLeft",
 ...
 * @see https://www.w3.org/TR/wai-aria-practices/
 */
export declare enum JumpMovementKey {
    Home = "Home",
    End = "End",
    AltHome = "Alt+Home",
    AltEnd = "Alt+End",
...
export declare type MovementKey = IncrementMovementKey | JumpMovementKey;
