...
function useActiveDescendantMovement(_a) {
    ...
    var _f = __read((0, react_1.useState)(defaultFocusedIndex), 2), focusedIndex = _f[0], setFocusedIndex = _f[1];
    var activeId = focusedIndex !== -1 ? getId(baseId, focusedIndex) : "";
    var _g = __read((0, useKeyboardMovement_1.useKeyboardMovement)(__assign(__assign({}, options), { valueKey: valueKey, getItemValue: getItemValue, focusedIndex: focusedIndex, items: items, onChange: function (data, itemRefs) {
            if (onChange) {
