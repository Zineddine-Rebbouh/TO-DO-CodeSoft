 ...
 */
export declare function useCloseOnEscape<E extends HTMLElement>(onRequestClose: () => void, disabled: boolean, onKeyDown?: KeyboardEventHandler<E>): KeyboardEventHandler<E> | undefined;
