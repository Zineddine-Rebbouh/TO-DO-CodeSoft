 ...
 */
export declare const DATA_RMD_NOSCROLL = "data-rmd-noscroll";
/**
 ...
 */
export declare function enableScrollLock(element: HTMLElement): void;
/**
 ...
 */
export declare function disableScrollLock(element: HTMLElement): void;
/**
 ...
 */
export declare function useScrollLock(enabled: boolean, selectorOrElement?: string | HTMLElement | (() => HTMLElement) | null): void;
