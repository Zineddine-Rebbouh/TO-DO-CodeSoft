...
exports.FocusContainer = (0, react_1.forwardRef)(function FocusContainer(_a, forwardedRef) {
    ...
    var _k = __read((0, useEnsuredRef_1.useEnsuredRef)(forwardedRef), 2), ref = _k[0], refHandler = _k[1];
    ...
    return ((0, jsx_runtime_1.jsx)(Component, __assign({}, props, { onKeyDown: handleKeyDown, ref: refHandler }, { children: children })));
});
