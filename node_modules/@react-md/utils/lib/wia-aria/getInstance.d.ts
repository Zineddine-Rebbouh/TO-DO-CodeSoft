 ...
 */
export declare type RefOrInstance = HTMLElement | null | MutableRefObject<HTMLElement | null>;
/**
 ...
 * @internal
 */
export declare function getInstance(refOrInstance: RefOrInstance): HTMLElement | null;
