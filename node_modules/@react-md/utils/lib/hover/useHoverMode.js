...
function useHoverMode(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.disabled, disabled = _c === void 0 ? false : _c, _d = _b.defaultVisible, defaultVisible = _d === void 0 ? false : _d, _e = _b.exitVisibilityDelay, exitVisibilityDelay = _e === void 0 ? constants_1.DEFAULT_HOVER_MODE_EXIT_TIME : _e;
    var mode = (0, mode_1.useUserInteractionMode)();
    var isTouch = mode === "touch";
    var _f = __read((0, react_1.useState)(defaultVisible), 2), visible = _f[0], setVisible = _f[1];
    var _g = __read((0, react_1.useState)(false), 2), stuck = _g[0], setStuck = _g[1];
    var timeoutRef = (0, react_1.useRef)();
    var _h = (0, useHoverModeContext_1.useHoverModeContext)(), visibleInTime = _h.visibleInTime, enableHoverMode = _h.enableHoverMode, disableHoverMode = _h.disableHoverMode, startDisableTimer = _h.startDisableTimer;
    ...
    var clearHoverTimeout = (0, react_1.useCallback)(function () {
        window.clearTimeout(timeoutRef.current);
    }, []);
