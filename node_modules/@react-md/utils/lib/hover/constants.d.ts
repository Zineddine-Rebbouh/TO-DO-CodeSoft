 ...
 * @remarks \@since 2.8.0
 */
export declare const DEFAULT_HOVER_MODE_VISIBLE_IN_TIME = 1000;
/**
 ...
 * @remarks \@since 2.8.0
 */
export declare const DEFAULT_HOVER_MODE_DEACTIVATION_TIME = 1000;
/**
 ...
 */
export declare const DEFAULT_HOVER_MODE_EXIT_TIME = 300;
