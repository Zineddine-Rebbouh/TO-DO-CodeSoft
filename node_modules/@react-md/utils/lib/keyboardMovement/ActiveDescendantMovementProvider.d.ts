 ...
 * @remarks \@since 5.0.0
 */
export interface ActiveDescendantMovementProviderProps extends ActiveDescendantContext {
    children: ReactNode;
}
/**
 ...
 * @remarks \@since 5.0.0
 */
export declare function ActiveDescendantMovementProvider({ children, activeId, setActiveId, }: ActiveDescendantMovementProviderProps): ReactElement;
