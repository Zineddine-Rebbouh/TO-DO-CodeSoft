...
function caseInsensitiveFilter(query, searchable, options) {
    ...
    var _a = (0, defaults_1.defaults)(options, utils_1.DEFAULT_SEARCH_OPTIONS), getItemValue = _a.getItemValue, valueKey = _a.valueKey, trim = _a.trim, ignoreWhitespace = _a.ignoreWhitespace, _b = _a.startsWith, startsWith = _b === void 0 ? false : _b;
    query = (0, utils_1.getSearchString)(query, true, trim, ignoreWhitespace);
    if (!query || !searchable.length) {
        return searchable;
    }
    return searchable.filter(function (item) {
        var value = (0, utils_1.getSearchString)(getItemValue(item, valueKey), true, trim, ignoreWhitespace);
        if (startsWith) {
