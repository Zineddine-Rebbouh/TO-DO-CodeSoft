...
exports.GridCell = (0, react_1.forwardRef)(function GridCell(_a, ref) {
    ...
    var cellStyle = __assign({ gridColumnStart: colStart, gridColumnEnd: colEnd, gridRowStart: rowStart, gridRowEnd: rowSpan ? "span ".concat(rowSpan) : rowEnd }, style);
    ...
    return ((0, jsx_runtime_1.jsx)("div", __assign({}, props, { ref: ref, style: cellStyle, className: cellClassName }, { children: children })));
});
