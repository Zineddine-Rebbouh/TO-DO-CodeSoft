...
function useGridList(_a) {
    ...
    var _h = __read((0, useEnsuredRef_1.useEnsuredRef)(propRef), 2), ref = _h[0], mergedRef = _h[1];
    var _j = __read((0, react_1.useState)(defaultSize || { columns: -1, cellWidth: maxCellSize }), 2), gridSize = _j[0], setGridSize = _j[1];
    ...
    var _k = __read((0, useResizeObserver_1.useResizeObserver)(recalculate, {
        ref: mergedRef,
        disableHeight: disableHeight,
        disableWidth: disableWidth,
    }), 2), refHandler = _k[1];
    var mergedStyle = __assign(__assign({}, style), (_b = {}, _b[exports.CELL_SIZE_VAR] = "".concat(gridSize.cellWidth, "px"), _b));
    if (cellMargin) {
