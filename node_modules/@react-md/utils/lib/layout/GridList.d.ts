...
export interface GridListProps extends HTMLAttributes<HTMLDivElement>, UseGridListOptions {
    /**
 ...
 */
export declare const GridList: import("react").ForwardRefExoticComponent<GridListProps & import("react").RefAttributes<HTMLDivElement>>;
