 ...
 */
export declare const toWidthPart: (v: QuerySize | undefined, prefix: "min" | "max") => string;
interface WidthMediaQuery {
    min?: QuerySize;
    max?: QuerySize;
}
declare type WidthMediaQuerys = {
    min: QuerySize;
} | {
    max: QuerySize;
} | {
 ...
 */
export declare function useWidthMediaQuery({ min, max, }: WidthMediaQuery & WidthMediaQuerys): boolean;
export {};
