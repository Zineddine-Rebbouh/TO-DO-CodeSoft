...
exports.DesktopOnly = exports.TabletOnly = exports.PhoneOnly = exports.MobileOnly = void 0;
...
function MobileOnly(_a) {
    ...
    var _c = (0, useAppSize_1.useAppSize)(), isPhone = _c.isPhone, isTablet = _c.isTablet;
    if (isPhone || isTablet) {
        return children;
    }
    return fallback;
...
function PhoneOnly(_a) {
    var children = _a.children, _b = _a.fallback, fallback = _b === void 0 ? null : _b;
    var isPhone = (0, useAppSize_1.useAppSize)().isPhone;
    if (isPhone) {
        return children;
    }
    return fallback;
...
function TabletOnly(_a) {
    var children = _a.children, _b = _a.fallback, fallback = _b === void 0 ? null : _b;
    var isTablet = (0, useAppSize_1.useAppSize)().isTablet;
    if (isTablet) {
        return children;
    }
    return fallback;
...
function DesktopOnly(_a) {
    var children = _a.children, _b = _a.fallback, fallback = _b === void 0 ? null : _b;
    var isDesktop = (0, useAppSize_1.useAppSize)().isDesktop;
    if (isDesktop) {
        return children;
    }
    return fallback;
