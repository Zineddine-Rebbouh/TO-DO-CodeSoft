...
declare type Enable = () => void;
declare type Disable = () => void;
declare type Toggle = () => void;
declare type SetToggle = Dispatch<SetStateAction<boolean>>;
declare type ReturnValue = [boolean, Enable, Disable, Toggle, SetToggle];
/**
 ...
 */
export declare function useToggle(defaultToggled: boolean | (() => boolean)): ReturnValue;
export {};
