...
var scrollbarSize_1 = require("../layout/scrollbarSize");
 ...
 */
function getFixedPosition(options) {
    var _a;
    var element = options.element, _b = options.anchor, anchor = _b === void 0 ? constants_1.BELOW_CENTER_ANCHOR : _b, initialX = options.initialX, _c = options.vwMargin, vwMargin = _c === void 0 ? 16 : _c, _d = options.vhMargin, vhMargin = _d === void 0 ? 16 : _d, _e = options.xMargin, xMargin = _e === void 0 ? 0 : _e, _f = options.yMargin, yMargin = _f === void 0 ? 0 : _f, _g = options.width, widthType = _g === void 0 ? "auto" : _g, _h = options.preventOverlap, preventOverlap = _h === void 0 ? false : _h, _j = options.transformOrigin, transformOrigin = _j === void 0 ? false : _j, _k = options.disableSwapping, disableSwapping = _k === void 0 ? false : _k, _l = options.disableVHBounds, disableVHBounds = _l === void 0 ? false : _l;
    var initialY = options.initialY;
    var container = (0, findSizingContainer_1.findSizingContainer)(options.container);
        ...
        return {
            ...
            style: {
                ...
                transformOrigin: transformOrigin
                    ? (0, getTransformOrigin_1.getTransformOrigin)({ x: anchor.x, y: anchor.y })
                    : undefined,
            },
        };
    }
    ...
    var elementRect = (0, getElementRect_1.getElementRect)(element);
    var height = elementRect.height;
    var elWidth = elementRect.width;
    if (widthType === "min") {
        elWidth += (0, scrollbarSize_1.scrollbarSize)();
    ...
    var _m = (0, createHorizontalPosition_1.createHorizontalPosition)({
        x: anchor.x,
        vw: vw,
        vwMargin: vwMargin,
        xMargin: xMargin,
    ...
    var _o = (0, createVerticalPosition_1.createVerticalPosition)({
        y: anchor.y,
        vh: vh,
        vhMargin: vhMargin,
        yMargin: yMargin,
    ...
    return {
        ...
        style: {
            ...
            position: disableVHBounds ? "absolute" : "fixed",
            transformOrigin: transformOrigin
                ? (0, getTransformOrigin_1.getTransformOrigin)({
                    x: actualX,
                    y: actualY,
