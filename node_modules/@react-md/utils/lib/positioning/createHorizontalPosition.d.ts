 ...
 * @internal
 */
export interface CreateHorizontalPositionOptions extends Required<Pick<FixedPositionOptions, "vwMargin" | "xMargin" | "width" | "disableSwapping">> {
 ...
 * @internal
 */
export declare function createEqualWidth(options: EqualWidthOptions): XPosition;
/**
 * Creates the horizontal position for a fixed element with the provided
 * options.
 * @internal
 */
export declare function createHorizontalPosition(options: CreateHorizontalPositionOptions): XPosition;
export {};
