...
exports.getBelowCoord = exports.getBottomCoord = exports.getCenterYCoord = exports.getTopCoord = exports.getAboveCoord = exports.getRightCoord = exports.getInnerRightCoord = exports.getCenterXCoord = exports.getInnerLeftCoord = exports.getLeftCoord = void 0;
/**
...
exports.getLeftCoord = getLeftCoord;
/**
 * Creates the `left` style value for an element that should be fixed to the
...
exports.getInnerLeftCoord = getInnerLeftCoord;
/**
 * Creates the `left` style value for an element that should be fixed to the
...
exports.getCenterXCoord = getCenterXCoord;
/**
 * Creates the `left` style value for an element that should be fixed to the
...
exports.getInnerRightCoord = getInnerRightCoord;
/**
 * Creates the `left` style value for an element that should be fixed to the
...
exports.getRightCoord = getRightCoord;
/**
...
exports.getAboveCoord = getAboveCoord;
/**
...
exports.getTopCoord = getTopCoord;
/**
...
function getCenterYCoord(_a) {
    var yMargin = _a.yMargin, elHeight = _a.elHeight, initialY = _a.initialY, containerRect = _a.containerRect;
    var containerCenter = containerRect.height / 2;
    var elementCenter = elHeight / 2;
    return ((initialY !== null && initialY !== void 0 ? initialY : containerRect.top + containerCenter + yMargin) - elementCenter);
}
exports.getCenterYCoord = getCenterYCoord;
/**
...
exports.getBottomCoord = getBottomCoord;
/**
 * Creates the `top` style value for an element that should be fixed to the
...
exports.getBelowCoord = getBelowCoord;
