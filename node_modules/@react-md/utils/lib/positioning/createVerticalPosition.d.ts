...
/** @internal */
export interface CreateVerticalPositionOptions extends Required<Pick<FixedPositionOptions, "yMargin" | "vhMargin" | "preventOverlap" | "disableSwapping" | "disableVHBounds">> {
    y: VerticalPosition;
    vh: number;
    initialY?: number;
    elHeight: number;
 ...
 * @internal
 */
export declare function createVerticalPosition(options: CreateVerticalPositionOptions): YPosition;
export {};
