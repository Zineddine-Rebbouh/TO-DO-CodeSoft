 ...
 */
export declare function AppSizeListener({ children, onChange, phoneMaxWidth, tabletMinWidth, tabletMaxWidth, desktopMinWidth, desktopLargeMinWidth, defaultSize, }: AppSizeListenerProps): ReactElement;
