 ...
 */
export declare function isContrastCompliant(background: HexString, foreground: HexString, compliance?: ContrastRatioCompliance | number): boolean;
