 ...
 * @remarks \@since 2.7.0
 */
export declare function getRadioItemValue(value: RadioItem): string;
/**
 ...
 * @remarks \@since 2.7.0
 */
export declare const defaultGetRadioStyle: (item: RadioItemStyleObject) => CSSProperties | undefined;
/**
 ...
 * @remarks \@since 2.7.0
 */
export declare const defaultGetRadioClassName: (item: RadioItemStyleObject) => string | undefined;
