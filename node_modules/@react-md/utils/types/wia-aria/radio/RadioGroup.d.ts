 ...
 * @remarks \@since 2.7.0
 */
export interface BaseRadioGroupProps extends Omit<HTMLAttributes<HTMLSpanElement>, "onChange"> {
    /**
     */
    id: string;
    /**
 ...
 * @remarks \@since 2.7.0
 */
export declare type RadioGroupProps = LabelRequiredForA11y<BaseRadioGroupProps>;
/**
 ...
 * @remarks \@since 2.7.0
 */
export declare const RadioGroup: import("react").ForwardRefExoticComponent<RadioGroupProps & import("react").RefAttributes<HTMLSpanElement>>;
