 ...
 * @remarks \@since 2.7.0
 */
export declare type RadioWidgetAttributes = Omit<HTMLAttributes<HTMLSpanElement>, "id" | "aria-checked" | "onChange" | "tabIndex">;
/**
 * @remarks \@since 2.7.0
 */
 ...
 * @remarks \@since 2.7.0
 */
export declare type RadioItem = string | RadioItemValueObject;
/**
 * @remarks \@since 2.7.0
 */
