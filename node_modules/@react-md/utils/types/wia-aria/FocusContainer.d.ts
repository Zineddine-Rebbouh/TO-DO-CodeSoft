...
export interface FocusContainerProps extends FocusContainerOptionsProps, HTMLAttributes<HTMLElement> {
    /**
 ...
 */
export declare const FocusContainer: import("react").ForwardRefExoticComponent<FocusContainerProps & import("react").RefAttributes<HTMLDivElement>>;
